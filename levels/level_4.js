...
class Level_4 extends Phaser.Scene {
    ...
    create() {
        ...
        p2text = this.add.text(300, 20, "Question 4:", {
            fontSize: "24px",
            fill: 'white'
        });
    ...
    level_platforms(platform) {
        ...
        var ledge1 = platform.create(350, 200, 'platform').setScale(0.25, 0.07).refreshBody();
        ...
        var ledge4 = platform.create(350, 500, 'platform').setScale(0.25, 0.07).refreshBody();
        ledge1.body.immovable, ledge2.body.immovable, ledge3.body.immovable, ledge4.body.immovable = true; //surface doesn't move
    }
